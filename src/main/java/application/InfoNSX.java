...
public class InfoNSX extends JFrame implements ActionListener{
    ...
    InfoNSX () {
            ...
            jtMa=new JTextField("Mã nhà sản xuất tự động tạo!");
    ...
    public void add() {
        jpnBT.add(add);
        heading.setText("Thêm nhà sản xuất");
    }
    public void edit(int maNSX, String tenNSX, String diaChi, String soDienThoai) {
        jpnBT.add(edit);
        heading.setText("Sửa thông tin nhà sản xuất");
        jtMa.setText(Integer.toString(maNSX));
        jtTen.setText(tenNSX);
        jtDC.setText(diaChi);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource()==add) {
            ...
            */
            ...
            if (count==0) {
                NSXArr.add(0,ten,diachi,sodienthoai);
                alter=true;
                dispose();
                JOptionPane.showMessageDialog(null,"Thêm thành công","Thêm nhà sản xuất",JOptionPane.PLAIN_MESSAGE);
            }
        ...
        if (e.getSource()==edit) {
            ...
            */
            ...
            if (count==0) {
                 NSXArr.edit(Integer.parseInt(jtMa.getText()),ten,diachi,sodienthoai);
                alter=true;
                dispose();
                JOptionPane.showMessageDialog(null,"Sửa thành công","Sửa thông tin nhà sản xuất",JOptionPane.PLAIN_MESSAGE);
            }
